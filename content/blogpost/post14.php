...
I don't use the IR values to track (that's what the MotionPlus is for), but it'll recenter when facing the IR bar (which is necessary, since the MotionPlus has a lot of drift).
